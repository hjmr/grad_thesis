...
\juniv          {神戸大学}                                      % 大学名
\jfaculty       {国際文化学研究科}                              % 学部、学科
\jauthor        {神戸 太郎}                                     % 著者
\jadvisor       {ほげ山 ほげ太}{教授}                           % 指導教員、『{名前}{肩書}』の順
\jsubadvisor    {ばあ中 ほげ子}{教授}                           % 副指導教員、『{名前}{肩書}』の順
\jhyear         {平成30年度}                                    % 平成○年度
\jsyear         {2018}                                          % 西暦○年度
...
\eadvisor       {Professor}{Hogeta Hogeyama}                    % 指導教員、『{肩書}{名前}』の順
\esubadvisor    {Professor}{Hogeko Bahnaka}                     % 副指導教員、『{肩書}{名前}』の順
\eyear          {2018}                                          % 西暦○年
